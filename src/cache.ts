 ...
 *   Layer 2  Worker <- Last.fm  this module
 *
 ...
 *   getRecentTracks response, so this layer is what stops a handful of card
 *   variants multiplying into a handful of API calls.
 * - Album art outlives the card. Art is immutable and cached for ~24h, while
