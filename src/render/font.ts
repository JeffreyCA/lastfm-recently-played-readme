 ...
 * slightly per platform. Width-sensitive runs should let the browser lay out
 * adjacent text together, or pin the rendered advance with `textLength` when
 * a non-text sibling depends on the server-side estimate.
 *
