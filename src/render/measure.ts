 ...
 * 0.38 ("J") to 0.95 ("W"), so a category average leaves a heart placed after
 ...
 * and matters on long ones - a 39-character title came out ~4px short, which
 * was enough to close the gap before a heart drawn after it.
 */
